...
* [安装](installation/README.md)
   * [Debian和Ubuntu](installation/on_debian_and_ubuntu.md)
   * [RedHat和CentOS](installation/on_redhat_and_centos.md)
   * [Arch Linux](installation/on_arch_linux.md)
   * [Gentoo Linux](installation/on_gentoo_linux.md)
   * [在macOS用Homebrew](installation/on_mac_osx_using_homebrew.md)
   * [在Linux用Linuxbrew](installation/on_linux_using_linuxbrew.md)
   * [在Windows的Linux虚拟机](installation/on_bash_on_ubuntu_on_windows.md)
   * [通过压缩包](installation/from_a_targz.md)
   * [通过源码](installation/from_source_repository.md)
